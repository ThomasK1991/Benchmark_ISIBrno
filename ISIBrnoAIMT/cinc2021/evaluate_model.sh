...
# Define paths
PYTHON_SCRIPT="/users/newc6477/Benchmark_ISIBrno/ISIBrnoAIMT/cinc2021/evaluate_model.py"
LABELS_PATH="/data/newc6477/Test_data/test_data"
OUTPUTS_PATH="/users/newc6477/Benchmark_ISIBrno/ISIBrnoAIMT/cinc2021/outputs"
SCORES_FILE="/users/newc6477/Benchmark_ISIBrno/ISIBrnoAIMT/cinc2021/scores.csv"
CLASS_SCORES_FILE="/users/newc6477/Benchmark_ISIBrno/ISIBrnoAIMT/cinc2021/class_scores.csv"

# Run the Python script
python "$PYTHON_SCRIPT" "$LABELS_PATH" "$OUTPUTS_PATH" "$SCORES_FILE" "$CLASS_SCORES_FILE"
