...
# Define paths
PYTHON_SCRIPT="/users/newc6477/Benchmark_ISIBrno/ISIBrnoAIMT/cinc2021/train_model.py"
...
python "$PYTHON_SCRIPT" "$DATA_PATH" "$MODEL_PATH" 
