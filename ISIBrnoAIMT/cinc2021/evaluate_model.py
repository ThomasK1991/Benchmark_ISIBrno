...
if __name__ == '__main__':
    ...
    print(output_string)
    with open('/users/newc6477/Benchmark_ISIBrno/ISIBrnoAIMT/cinc2021/outputs.txt', 'w') as f:
    ...
    with open('/users/newc6477/Benchmark_ISIBrno/ISIBrnoAIMT/cinc2021/outputs/table.txt', 'w') as f:
